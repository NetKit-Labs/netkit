// TFLM MNIST CNN invoke-time benchmark (pairs with benchmark/netkit/mnist_cnn_bench).
...
TfLiteStatus RunBenchmark() {
  ...
  MicroPrintf("TFLM MNIST CNN benchmark");
  ...
  BenchmarkStats::PrintSummary("tflm", "cnn", "reference",
