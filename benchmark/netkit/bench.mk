...
# Optional: extra -D flags for benches (e.g. -DNETKIT_BENCH_ARENA_MB=96 on Pi).
EXTRA_BENCH_CPPFLAGS ?=
BENCH_KERNEL_CPPFLAGS += $(EXTRA_BENCH_CPPFLAGS)
