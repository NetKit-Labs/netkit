...
std::size_t CmsisDepthwiseConv2dS8WorkspaceBytes(uint32_t in_h,
                                                 uint32_t in_w,
                                                 int kernel_h,
                                                 int kernel_w,
                                                 int stride,
...
void CmsisBumpConv2dS8Workspace(uint32_t in_h,
                                ...
                                int out_channels)
{
    BumpMaxKernelWorkspace(CmsisConv2dS8WorkspaceBytes(
        in_h, in_w, kernel_size, stride, pad_h, pad_w, in_channels, out_channels));
}
...
void CmsisBumpDepthwiseConv2dS8Workspace(uint32_t in_h,
                                           uint32_t in_w,
                                           int kernel_h,
                                           int kernel_w,
                                           int stride,
                                           ...
                                           int channels)
{
    BumpMaxKernelWorkspace(CmsisDepthwiseConv2dS8WorkspaceBytes(
        in_h, in_w, kernel_h, kernel_w, stride, pad_h, pad_w, channels));
}
                                    ...
                                    int stride)
{
    BumpMaxKernelWorkspace(
        Conv2dWorkspaceBytes(out_h, out_w, kernel_h, kernel_w, in_channels, stride));
}
