...
| Target | Role |
|--------|------|
| **CPU** | Desktop dev — CLI, embedded regression (81 cases), Python ONNX parity (77), AOT compile tests, embedded smoke orchestration on host (`test_mlp`, `cnn_4x4_single`, `speech_kws`) |
