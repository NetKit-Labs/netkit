...
- **Regression tests** — 86 embedded `.nk` cases (C++/C) plus Python ONNX parity (76), timm backbone pack/runtime parity, and AOT compile tests via `make test`
...
| ONNX parity | Python | `python/tests/test_onnx_parity.py` | 76 (.nk vs ONNX Runtime on bundled sidecars) |
