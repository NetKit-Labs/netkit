// NUCLEO-F446RE TFLM MNIST DS-CNN int8 invoke benchmark — same 10 images as benchmark/netkit.
...
#define TFLM_CNN_DW_INT8_BACKEND_LABEL "cmsis-nn"
#else
...
using MnistCnnDwOpResolver = tflite::MicroMutableOpResolver<10>;
...
extern "C" int main(void)
{
    ...
    MnistCnnDwOpResolver op_resolver;
    ...
    uart_write("\r\nTFLM NUCLEO-F446RE MNIST DS-CNN int8 benchmark\r\n");
    ...
    uart_printf(
        "BENCHMARK_SUMMARY runtime=tflm model=cnn_dw_int8 backend=%s mean_us=%lu runs=%d\r\n",
        TFLM_CNN_DW_INT8_BACKEND_LABEL,
        mean_us_i,
        kRuns);
    uart_write("\r\nDONE\r\n");
